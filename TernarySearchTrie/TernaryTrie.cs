...
namespace Global.SearchTrie
{
    ...
    /// <typeparam name="TKeyPiece">The peices that the <typeparamref name="TKey"/> will be split into that are comparable (eg. char's).</typeparam>
    /// <typeparam name="TValue">The object to relate with <typeparamref name="TKey"/>.</typeparam>
        ...
        where TKeyPiece : IComparable
    {
        ...
        /// <summary>
        /// Set the visted status of all nodes in the tree.
        /// </summary>
        ...
        /// <summary>
        /// TODO: Collects all items in the Trie with the given prefix.
        /// </summary>
        /// <param name="prefix">The prefix to match.</param>
        /// <returns>A list of values with the given prefix.</returns>
        private List<TValue> CollectAfter(IList<TKeyPiece> prefix)
        {
            // TODO
